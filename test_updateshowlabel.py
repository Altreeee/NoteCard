...
#############################################################启用卡牌后的动作################################################
    ...
    def WeakAWork(self,work_name):
        ...
        self.text_content = tk.Text(self.frameyoushang, wrap='word', height=10, width=50)
        self.text_content.grid(row=1,column=0,columnspan=2)
        self.text_content.delete(1.0, tk.END)
        self.text_content.insert(tk.END, content)
         
        #notebook
        self.custom_notebook = CustomNotebook(self.frameyoushang, width=50, height=15)
        self.custom_notebook.grid(row=2, column=0,columnspan=2)
            # 添加保存按钮
